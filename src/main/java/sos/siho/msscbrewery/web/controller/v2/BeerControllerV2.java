package sos.siho.msscbrewery.web.controller.v2;

import org.springframework.http.HttpHeaders;
import org.springframework.http.HttpStatus;
import org.springframework.http.ResponseEntity;
import org.springframework.web.bind.annotation.*;
import sos.siho.msscbrewery.services.v2.BeerServiceV2;
...
public class BeerControllerV2 {
    ...
    public ResponseEntity<BeerDto> handleUpdate(@PathVariable(value = "beerId") UUID beerId, @RequestBody BeerDto beerDto) {
